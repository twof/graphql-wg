...
1. TSC Elections for 2022, open nominations process (5m, Lee)
...
1. Client Controlled Nullability progress report and call for reviews (5m, Alex Reilly)
   - [Action item containing links to spec and GraphQL.js changes](https://github.com/graphql/graphql-wg/issues/694)
